<template>
  <transition name="fade">
    <div v-show="visible" class="masker">
      <div class="mask-layer"></div>
      <transition name="fadein">
        <div class="preview-box" v-show="visible" @animationend="animationendAction">
          <div class="img-list-box" ref="imgListBox" @click="hide">
            <div class="img-list-wraper" :style="{ width: `${imgListLen * 100}%`, transform: `translate3d(${diffX}px, 0, 0)`, transitionDuration: effect ? '.3s' : '0s' }">
                <div v-for="(src, index) in images" :key="index" class="img-item" @touchstart="touchStart">
          ...
          <div class="view-index">{{activeIndex + 1}}/{{imgListLen}}</div>
        </div>
      </transition>
    </div>
  </transition>
